    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                if (GlobalIllumination.z > 100)
                    return float4(0, 0, 1, 1);
                return GlobalIllumination.z;//float4(GlobalIllumination.xyz, 1);
                //return _UnigmaDepthShadows;
                //return  FinalColor*0.2 + GlobalIllumination;
                //return lerp(FinalColor, FinalColor + GlobalIllumination*0.1025, 0.341+GlobalIllumination.w*0.712+(0.182 * (1.0-shadows)));
