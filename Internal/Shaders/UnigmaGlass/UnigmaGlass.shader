...
Shader "Unigma/UnigmaGlass"
{
	Properties
	{
		_Tint("Tint", Color) = (1,1,1,1)
		_FresnelColor("Fresnel Color", Color) = (1,1,1,1)
		_FresnelExponent("Fresnel Exponent", Range(0, 20)) = 1
		_MainTex("Albedo", 2D) = "white" {}
		_DisplacementTex("Displacement Effect", 2D) = "white" {}
