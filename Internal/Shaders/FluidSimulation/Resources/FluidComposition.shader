...
//------------------------------------------------------------
                ...
                float4 waterDeepness = lerp(_ShallowWaterColor, _DeepWaterColor, 13.95 * fluidsDepth.z);
                ...
                float4 colorSurfaceFluid = 0.1715*heatMapIntensity + fluidColorFinal + edge*2 + colorFieldLerp * 0.0935 + surface * 0.0756;
