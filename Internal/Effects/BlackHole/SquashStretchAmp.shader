	...
	Properties
	{
		...
		SubShader
		{
			...
			void surf(Input i , inout SurfaceOutput o)
			{
				...
				float shadow = 0.03;//SHADOW_ATTENUATION(i);
				...
				fixed4 text = tex2D(_MainTex, i.uv2_MainTex);
				...
				o.Albedo = result.xyz;
				o.Emission = result.xyz;//tex2D(_Texture, (((mul(UNITY_MATRIX_MV, fixed4(ase_vertexNormal , 0.0)).xyz).xy * 0.5) + 0.5)).rgb;
				o.Alpha = result.a;
			}
